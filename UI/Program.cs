    ...
    private static void CrearProducto()
{
    ...
    string precioString;
    bool esValidoPrecio = false;
        do{ 
            Console.Write("Precio: ");
            precioString=Console.ReadLine();
            esValidoPrecio = Decimal.TryParse(precioString,out productoPrecio);
            if(!esValidoPrecio){Console.WriteLine("Ingrese un valor valido");}
        }while(!esValidoPrecio);
    
    int productoStock;
    string stockString;
    bool esValidoStock = false;
        do{
            Console.Write("Unidades: ");
            stockString = Console.ReadLine();
            esValidoStock  = int.TryParse(stockString,out productoStock);
            if(!esValidoStock){Console.WriteLine("Ingrese un valor valido");}
        }while(!esValidoStock);
    
    producto.Precio= productoPrecio;
    producto.Stock= productoStock;
    ...
    private static void EliminarProducto()
{
    ...
    n = int.TryParse(Console.ReadLine(),out id);
    if(!n){Console.WriteLine("El ID no es valido");
    if(_productoService.ObtenerProductoPorId(id)==null){
